...
public class TimelineRow {
    ...
    public TimelineRow(int id, Date date, String title, String description, Bitmap image, int bellowLineColor, int bellowLineSize, int imageSize, int backgroundColor, int backgroundSize, int dateColor, int titleColor, int descriptionColor, boolean flag) {
        this.id = id;
        this.date = date;
        this.title = title;
        this.description = description;
    ...
    public TimelineRow(int id, Date date, String title, String description, Bitmap image, int bellowLineColor, int bellowLineSize, int imageSize, int backgroundColor, int backgroundSize, int dateColor, int titleColor, int descriptionColor, ActivityVO avo, boolean flag) {
        this.id = id;
        this.date = date;
        this.title = title;
        this.description = description;
    ...
    public ActivityVO getAvo() {
        return avo;
    }

    public void setAvo(ActivityVO avo) {
        this.avo = avo;
    }
